...
const mockData = {
	ai_modules: [
		{ name: 'AttentionModule', activation: 0.7 },
		{ name: 'MemoryUnit', activation: 0.5 },
		{ name: 'DecisionLayer', activation: 0.9 }
	]
}
...
const App = () => {
		...
		<div className="p-4 text-white bg-zinc-900 min-h-screen">
			<h1 className="text-2xl font-bold mb-4">AISystemDiagram Test</h1>
			<AISystemDiagram data={mockData} />
		</div>
	)
}
